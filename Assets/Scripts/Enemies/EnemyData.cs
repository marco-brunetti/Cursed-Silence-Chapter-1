...
namespace Enemies
{
    ...
    public class EnemyData : ScriptableObject
    {
        ...
        [field: SerializeField, Header("Damage"), Range(0, 50)] public int LightAttackDamage { get; private set; } = 10;
        ...
        [field: SerializeField, Header("Poise Decrement"), Range(0, 30)] public int LightAttackPoiseDecrement { get; private set; } = 10;
        ...
        [field: SerializeField, Header("Probability"), Range(0, 20)] public int HeavyAttackProbability { get; private set; } = 20;
        ...
        [field: SerializeField, Header("Player Tracking")] public LayerMask DetectionMask { get; private set; }
